...
const brazePath = path.resolve(`refresh/dataFolder/test/braze`)
...
const main = async (time) => {
  ...
  const attributes = ['last_exam_date','next_appointment_date']

  await brazeDataToCsv(braze_refresh_data, attributes, braze_refresh_csv)
