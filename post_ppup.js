...
const brazePath = path.resolve(`pp/dataFolder/${MD}/Post_braze`)
const MDPPath = path.resolve(`pp/dataFolder/${MD}/MDP`)
const deltaPath = path.resolve(`pp/dataFolder/${MD}/Post_Delta`)
...
const main = async () => {
  ...
  const result_PP_csv = `./pp/Result/pp_post_delta_${MD}.csv`
